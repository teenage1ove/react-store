	...
	return (
		<section className={styles.product}>
			...
			<div className={styles.info}>
				...
				<div>
					Rate:{' '}
					<span className={styles.rating} style={ratingColor(rating.rate)}>
						{rating.rate}
					</span>
				</div>
				<div>
					Count: <span className={styles.count}>{rating.count}</span>
				</div>
				...
				<div className={styles.actions}>
					...
					<button className={styles.favourite} onClick={() => null}>
						Add to favorites
					</button>
				</div>
